...
type IconName =
  | 'home' | 'family' | 'docs' | 'journal' | 'map'
  | 'plane' | 'ticket' | 'reservation' | 'passport'
  | 'location' | 'upload' | 'add' | 'restaurant'
  | 'camera' | 'sun' | 'anchor' | 'shield'
...
const ICONS: Record<IconName, ReactElement> = {
  ...
  family: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="9" cy="7" r="3"/><circle cx="17" cy="6" r="2.5"/>
      <path d="M3 21v-2a5 5 0 0 1 10 0v2"/><path d="M17 21v-1.5a3.5 3.5 0 0 0-2.5-3.35"/>
    </svg>
  ),
  docs: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
  ...
  passport: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M7 20h10"/><line x1="9" y1="16" x2="15" y2="16"/>
    </svg>
  ),
  location: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
